...
//       {/* Install Banner */}
//       {showInstallBanner && (
//         <div className="fixed bottom-24 left-4 right-4 z-50 bg-panel border border-accent-red/30 rounded-lg p-4 flex items-center justify-between gap-3">
//           <div>
//             <p className="text-xs font-orbitron text-white uppercase tracking-wider">Install App</p>
//             <p className="text-[10px] text-gray-500 mt-0.5">Add to home screen for the full experience</p>
//           </div>
...
export default function App() {
  ...
  return (
    <>
      ...
      {showInstallBanner && (
        <div className="fixed bottom-20 left-4 right-4 z-50 bg-panel border border-accent-red/30 rounded-lg p-4 flex items-center justify-between gap-3">
          <div>
            <p className="text-xs font-orbitron text-white uppercase tracking-wider">Install App</p>
            <p className="text-[10px] text-gray-500 mt-0.5">Add to home screen for the full experience</p>
          </div>
      ...
      {/* ── iOS Install Banner ────────────────────────────────────────────── */}
      {showIOSBanner && (
        <div className="fixed bottom-20 left-4 right-4 z-50 bg-panel border border-accent-red/30 rounded-xl p-4">
          {/* Close button */}
          <button
            onClick={() => {
          ...
          {/* Title */}
          <p className="text-xs font-orbitron text-white uppercase tracking-wider mb-3 pr-6">
            Install on iPhone
          </p>
          ...
          <div className="space-y-2.5">
            <div className="flex items-center gap-3">
              <div className="w-6 h-6 rounded-full bg-accent-red/20 border border-accent-red/40 flex items-center justify-center flex-shrink-0">
                <span className="text-[10px] font-orbitron text-accent-red font-bold">1</span>
              </div>
              <p className="text-[11px] text-gray-400 leading-tight">
                Tap the <span className="text-white font-semibold">Share</span> button{' '}
                <span className="text-accent-red">⎋</span> at the bottom of Safari
              </p>
            </div>

            <div className="flex items-center gap-3">
              <div className="w-6 h-6 rounded-full bg-accent-red/20 border border-accent-red/40 flex items-center justify-center flex-shrink-0">
                <span className="text-[10px] font-orbitron text-accent-red font-bold">2</span>
              </div>
              <p className="text-[11px] text-gray-400 leading-tight">
                Scroll down and tap{' '}
            ...
            <div className="flex items-center gap-3">
              <div className="w-6 h-6 rounded-full bg-accent-red/20 border border-accent-red/40 flex items-center justify-center flex-shrink-0">
                <span className="text-[10px] font-orbitron text-accent-red font-bold">3</span>
              </div>
              <p className="text-[11px] text-gray-400 leading-tight">
          ...
          <p className="text-[10px] text-gray-600 mt-3 pt-3 border-t border-white/5">
            Must be opened in Safari — Chrome on iOS does not support install
          </p>
        </div>
      )}
